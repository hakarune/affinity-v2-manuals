...
> **Tip:** Select and drag an end stop on the path to change the length and direction of the path. End stops can be recolored and be given reduced opacity from the **Co lour** panel.
...
3. Do one of the following:
  ...
  - **Windows:** From your Explorer window, drag the file of choice and drop it onto either the **Swatches** panel, **Color** panel or the Foreground/Background color selector.
...
1. With the **Gradient Tool** selected, click the layer content.
...
> **Note:** When creating a bitmap fill, the image will be placed as a tiled or repeating pattern that fills the selected area.
