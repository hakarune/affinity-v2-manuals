...
![Document templates](../../assets/images/templates.png)
...
> **Tip:** Using a single template folder shared between all Affinity apps means your templates can be kept in one place; if a template is edited it will be synchronized across all apps.
...
- [Create new documents](03-create-new-documents.md)
