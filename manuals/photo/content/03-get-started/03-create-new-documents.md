...
![New document](../../assets/images/newdocument.png)
...
- ![Account](../../assets/shared/ui/my_account_on.png) **Account**—registers your app, accesses your Affinity account and synchronizes with purchased content.
- ![New document](../../assets/shared/ui/new_doc_on.png) **New**—(default) creates new documents based on a supplied preset or a customized preset. The main area of the dialog displays a range of presets, depending on the Preset category chosen.
- ![Open document](../../assets/shared/ui/open_on.png) **Open**—use to locate and open previously created documents.
- ![Recent documents](../../assets/shared/ui/recent_on.png) **Recent**—shows recently opened documents, which can be pinned to make them permanently available.
- ![Document templates](../../assets/shared/ui/templates_on.png) **Templates**—sets a folder for your templates, and imports additional templates.
- ![Sample documents](../../assets/shared/ui/samples_on.png) **Samples**—shows sample documents created with the Affinity app.
...
- ![Landscape orientation](../../assets/shared/ui/landscape_doc_on.png) ![Portrait orientation](../../assets/shared/ui/portrait_doc_on.png) **Landscape** / **Portrait**—select whether to display your document in a landscape or portrait orientation.
- ![Presets menu](../../assets/shared/ui/moremenuicon.png) **Category options**—lets you rename or delete the associated category.
- **Preset entry**—a selectable preset showing thumbnail, page size and page dimensions.
- ![Add Preset](../../assets/shared/ui/add_preset.png) **Save Preset As**—saves a new custom preset to a category.
- ![Add Category](../../assets/shared/ui/add_category.png) **New Category**—creates a new custom preset category.
- ![Rename Preset](../../assets/shared/ui/rename_preset.png) **Rename Preset**—renames the currently selected preset.
- ![Remove preset](../../assets/shared/ui/trash_can.png) **Remove Preset**—deletes the currently selected preset.
...
- Margin:
  ...
  - ![link](../../assets/shared/ui/chainlinkconnected.png) ![Unlink](../../assets/shared/ui/chainlink.png) For the same margin value: Enable the Link symbol at right, and set any margin value; all other values will update to this.
...
> **Note:** When creating a new document, the Document Units define the exact size of your document on screen. For example, if you chose 'pixels', your document will display at its exact pixel size when exported and viewed on screen at 100%. Similarly, for physical Document Units (e.g., millimeters) you'll get the exact print size at 50% zoom (due to Retina screen).

> **Tip:** To change document units once a document has been created, use the settings on the context toolbar when the [View Tool](../32-tools/01-photo-editing-tools/01-view-tool.md) or [Zoom Tool](../32-tools/01-photo-editing-tools/07-zoom-tool.md) is selected.

> **Tip:** You can also [create a new document based on the contents of the clipboard](04-new-from-clipboard.md).

> **Tip:** Full transparency can be applied to the background of the document at any point by selecting **Transparent Background** from the **Document** menu.
...
2. Adjust the document's settings using the **Layout**, **Color** and **Margins** tabs. The preset name above the preview window displays an asterisk (*) to indicate the preset has been customized.
...
- [Embedding vs linking](../14-placing-external-content/01-embedding-vs-linking.md)
- [Open documents](01-open-documents-and-images.md)
- [Document templates](09-document-templates.md)
- [Color models](../12-color/02-color-models.md)
- [Document units](06-document-units.md)
