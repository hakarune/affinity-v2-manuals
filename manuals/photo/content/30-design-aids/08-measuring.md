...
The Measure Tool is hidden by default however it can be added to your set via **View**>**Customize Tools**.
...
- [Area Tool](08-measuring/01-tools-area.md)
- [Measure Tool](../32-tools/01-photo-editing-tools/05-measure-tool.md)
- [Snapping](11-snapping.md)
- [Dynamic guides](09-dynamic-guides.md)
- [Customizing Tools](../31-workspace/04-customize/03-tools-panel.md)
