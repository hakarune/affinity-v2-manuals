...
![Pen tablet](../../../assets/shared/pentablet.png)
...
For some tablet pens, the pen's eraser (using the opposite end of the pen) will activate the **Erase Brush Tool**.
...
When drawing with a pressure-sensitive pen tablet, the **Pen Tool**'s variable width strokes will automatically match the level of pressure applied. This can be controlled by adjusting the pressure sensitivity.

When using the **Paint Brush Tool**, a number of [controller options](../../23-painting-and-erasing/06-modifying-brushes.md) on the **Brushes** panel can also be adjusted to work alongside your tablet pen.
