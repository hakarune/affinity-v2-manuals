...
- To perform calculations in fields. See [Field input](02-using-regular-expressions-in-affinity/01-fieldinput.md) and [Expressions in field input](../38-expressions-for-field-input/01-expressions-for-field-input.md) for more information, including examples.
