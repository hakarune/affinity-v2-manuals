...
![Object Selection Tool with its modifiers.](../../../assets/shared/object_selection_tool_modifiers.jpg)
...
- **Multi-part Objects**—when enabled (default), the selection will include all parts of an object (if obstructed by another object, say). When disabled, the sampling object of the mask is limited to the area you hover over.
