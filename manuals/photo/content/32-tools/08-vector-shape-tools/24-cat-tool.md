...
The Affinity Cat shape tool can't be customized, well, not unless you convert him to curves first. We think he's cool enough.

**macOS:**

> **Note — Activating the Cat Tool:** To use the Cat shape tool, you must hold the `Alt`  as you open the Shapes pop-up menu. The Cat Tool will be available in the list.

**Windows:**

> **Note — Activating the Cat Tool:** To use the Cat shape tool, you must hold the `Shift`  as you open the Shapes pop-up menu. The Cat Tool will be available in the list.
