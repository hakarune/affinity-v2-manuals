...
The **QR Code Tool** allows you to draw a square in which Affinity generates a QR code for data that you specify via the context toolbar.

> **Note:** Like other shape tools, the QR Code Tool can be added to the Tools panel as a discrete item via **View > Customize Tools**.

### Settings

The following settings can be adjusted from the context toolbar:

- **Fill**—click the color swatch to display a pop-up panel to update the QR code's fill color.
...
- **Data**—displays the type of data contained in the QR code (e.g. a URL, SMS message, or Wi-Fi network credentials) and the associated data. Click to edit the QR code's data.
...
- [Draw QR codes](../../25-lines-and-shapes/08-draw-qr-codes.md)
