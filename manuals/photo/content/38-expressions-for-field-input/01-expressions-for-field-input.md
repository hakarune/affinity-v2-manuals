...
> **Note:** You can mix units of measurement in an expression. Affinity Photo 2 handles conversion automatically.
...
- When resizing a document via **Document > Resize Document**.
- Transforming one or more selected objects via the **Transform** panel<sup>*</sup>.
- Increasing stroke width on one or more selected objects via the tool's context toolbar<sup>*</sup>.
