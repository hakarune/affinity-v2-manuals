...
There are three types of text style in Affinity Photo 2 which are used for differing purposes.
...
![Options menu](../../../assets/shared/ui/moremenuicon.png) Group text styles only display in the [Text Styles panel](../../33-panels/28-text-styles-panel.md) and are best understood when **Show hierarchical** is set on the panel's Panel Preferences.
