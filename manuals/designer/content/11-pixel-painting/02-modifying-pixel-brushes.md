...
Pixel brushes can be modified before you paint on your design. Basic modifications can be made from the context toolbar, while advanced adjustments can be made from the **Brushes** panel. Both methods set brush properties for subsequent brush strokes, but the latter edits your brush permanently.
...
> **Note:** Hue, Saturation, and Luminosity Jitter settings affect the brush colour, which is set via the **Colour** panel. Similarly, Flow Jitter affects brush opacity, also set on the Colour panel.
...
> **Note:** Images for base textures should be JPEG or PNG. Any reasonably sized image will be acceptable as the base texture can be scaled (above). We recommend using an 8bit greyscale image with a size greater than or equal to 1024 x 1024 pixels. 16bit brushes will generally be slower with no appreciable increase in quality but can also be used.
...
> **Note:** For more information on creating custom pixel brush presets, see the [Creating custom pixel brushes](04-creating-custom-pixel-brushes.md) topic.
...
1. In the **Pixel Persona**, from **Tools** select the **Paint Brush Tool**.
2. On the **Brushes** panel, select a brush.
3. Do one of the following:
   - From your Finder window, drag a bitmap file and drop it onto either the **Swatches** panel, **Colour** panel or the active colour selector.
  - From your Explorer window, drag a bitmap file and drop it onto either the **Swatches** panel, **Colour** panel or the active colour selector.
  - From the **Assets** panel, drag an asset, e.g. a texture, onto either the **Swatches** panel, **Colour** panel or the active colour selector.
  - From the **Stock** panel, click or drag a photo onto either onto the **Swatches** panel, **Colour** panel or the active colour selector.
...
| Angle | Tablet pen | The behaviour of the brush stroke will be mapped to match the angle of the tablet pen (this varies from 0 to 360°). |
| Tilt | Tablet pen | The behaviour of the brush stroke will be mapped to match the tilt of the tablet pen (this varies from 0 to 90°). |
| Rotation | Tablet pen <sup>1</sup>, <sup>2</sup> | The behaviour of the brush stroke will be mapped to match the tablet pen's barrel rotation. |
| Cyclic | Tablet pen, mouse | The behaviour of the brush stroke will cycle between the range of available values shown on the slider. <sup>3</sup> |
...
| Wheel | Tablet pen <sup>1</sup>, <sup>2</sup> | The appearance of the brush stroke will change depending on the setting of the wheel on the airbrush pen. |
| Distance | Tablet pen, mouse | The width of the brush stroke will be affected by the length of the continuous stroke. |
...
- [Creating custom pixel brushes](04-creating-custom-pixel-brushes.md)
