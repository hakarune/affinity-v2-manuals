...
When you save your document all project information is preserved, allowing you to edit it at a later date. The design project is saved as a single file with the extension **.afdesign**.
...
Unsaved changes to a document are indicated by **[Modified]** or **[M]** to the right of the document's name at the top of its tab/window, and by a star to the right of the current document's name at the top of the app's window.
...
> **Note:** If you have only made modifications that are supported by an image file type (for example, a JPEG or PNG), then using the **Save** function will simply save over the top of the current file. If you have made modifications that are not supported, such as adding layers, then you can save the image as a project file or flatten and merge the changes to the existing file.
...
- Save your file with an .aftemplate extension.
...
>
>
> - **General>Save thumbnails with document**
