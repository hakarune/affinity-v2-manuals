...
The **Pen Tool** is used to precisely draw curves, closed shapes and straight lines.
...
### ![Add New Curve](../../../assets/shared/ui/add_to_curves_mode.png)
...
- **Action**—Manipulates the curve(s):
  ...
  - ![Smooth Curve](../../../assets/shared/ui/action_smooth_curve.png)
  ...
  - ![Reverse Curves](../../../assets/shared/ui/action_reverse_curves.png)
...
- **Snap**—Controls node snapping:
  ...
  - ![Align handle positions using snapping options](../../../assets/shared/ui/snap_curve_handle_position.png)
  ...
  - ![Perform construction snapping](../../../assets/shared/ui/snap_perform_construction_snapping.png)
  ...
  These options are independent of the global [snapping](../../17-design-aids/11-snapping.md) options.
- **Show Orientation**—displays the segment leading up to the end node in red to help visualise the direction of the closed shape's outline (used for winding fill mode); the drawing direction is away from the red-line indicator.
- **Use Fill**—When checked, the concave area of the line is filled with the currently set fill colour (from **Colour** panel) as you draw.
