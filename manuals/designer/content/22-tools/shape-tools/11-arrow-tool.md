# ![Arrow](../../../assets/shared/ui/arrow_tool.png)

 Arrow Tool

The **Arrow Tool** makes it easy to quickly add arrows to your design.
...
- **Proportional**—For Left or Right ends, when checked (default), the head proportions remain fixed when the arrow is resized. If this option is off, the head resizes with the design.
