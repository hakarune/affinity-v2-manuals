# ![Cloud](../../../assets/shared/ui/cloud_tool.png)

 Cloud Tool

The **Cloud Tool** makes it easy to add clouds to your designs.

![Cloud default](../../../assets/shared/shapes_cloud1.png)
*Default shape and handle position (in red) before customisation.*

## Customisation

The **Cloud Tool** has several options on the shape and on the context toolbar to enable the number of bubbles and the radius of the bubbles to be controlled.

![Cloud alternatives](../../../assets/shared/shapes_cloud2.png)
...
- **Inner radius**—controls the length of the bubbles relative to the width of the shape.
