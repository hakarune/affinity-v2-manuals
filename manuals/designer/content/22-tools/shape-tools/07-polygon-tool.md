# ![Polygon](../../../assets/shared/ui/polygon_tool.png)
...
> **Tip:** ### Equilateral triangles
>
>
> To create a true equilateral triangle (where all three sides are the same length), use the **Polygon** shape tool. Ensure that you constrain the shape with the `Shift`  as you draw, and then set the number of sides to 3 on the context toolbar.
