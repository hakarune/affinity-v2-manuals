# ![Cat Tool](../../../assets/shared/ui/cat_tool.png)

 Cat Tool

Cats are cool. Everyone loves cats, especially the guys here on the Affinity team! So if you need a cat to add to your images, the Affinity **Cat Tool** comes to the rescue!

![Cat Tool](../../../assets/shared/shapes_cat.png)

## Customisation

The Affinity Cat shape tool can't be customised, well, not unless you convert him to curves first. We think he's cool enough.

**macOS:**

> **Note:** ### Activating the Cat Tool
>
>
> To use the Cat shape tool, you must hold the `Alt`  as you open the Shapes pop-up menu. The Cat Tool will be available in the list.
...
>
>
> To use the Cat shape tool, you must hold the `Shift`  as you open the Shapes pop-up menu. The Cat Tool will be available in the list.
...
- ![Hide Selection while Dragging](../../../assets/shared/ui/hide_selection_while_dragging.png)
