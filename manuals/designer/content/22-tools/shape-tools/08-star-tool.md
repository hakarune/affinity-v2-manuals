# ![Star](../../../assets/shared/ui/star_tool.png)
...
![Star default](../../../assets/shared/shapes_star1.png)
*Default shape and handle position (in red) before customisation (with Curved edges enabled).*
...
![Star alternatives](../../../assets/shared/shapes_star2.png)
*Two possible outcomes when the options are customised (with Curved edges enabled).*
...
- [Double Star Tool](09-double-star-tool.md)
