# ![Pixel Persona only](../../../assets/shared/ui/pixelpersonaonly.png)
 ...
 ![Burn Brush](../../../assets/shared/ui/burn_brush_tool.png)

 Burn Brush Tool

Burning is a technique used in photography to control exposure and make areas of a photo darker.

The **Burn Brush Tool** allows you to precisely darken areas of your image, and even limit the effect to just shadows, highlights or midtones. The effect is cumulative—the more you paint over an area, the more pronounced the darkening effect will be.

> **Tip:** When using this brush you'll get the best results by using a low opacity setting and gradually building up the effect.
...
- [Dodge Brush Tool](01-dodge-brush-tool.md)
