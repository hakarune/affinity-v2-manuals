...
![Before](../../assets/images/layerorder1.png)
![After](../../assets/images/layerorder2.png)
*Reordering an object in the Layers panel*
...
- Drag a layer entry up/down the layer stack. When you see a blue line between two layers, drop the layer to place.

  If you pause during the drag procedure, you'll see a preview on the page for the current operation.
...
> **Note:** Layers or objects which are locked show in the Layers panel with a lock symbol, ![Locked layer](../../assets/shared/ui/locked_layer.png)
>
> , next to them. Selected locked layers appear with crosses around the bounding box.
