...
Additionally, you can use the Resource Manager's **Collect** feature to gather a document's resources, which may be distributed between multiple folders, into a single folder for ease of management, e.g. archiving a project when it is complete. If you wish to share a project, Affinity's Packaging feature is a better option.
...
- [About packaging](../14-saving-and-sharing/packaging/01-about-packaging.md)
