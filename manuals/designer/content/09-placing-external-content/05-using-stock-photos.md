...
The [Stock panel](../23-panels/15-stock-panel.md) allows you to search various stock imagery websites to find images and then add them to the page or create new documents from them.

![Stock panel](../../assets/images/panel_stock.png)
*The Stock panel populated with images.*

**![Search](../../assets/shared/ui/SearchFieldMagnify.png)
...
> **Note:** ![Clear search](../../assets/shared/ui/SearchFieldClose.png)
>
>  You can clear search results using the close icon.
...
- Drag an image thumbnail from the panel and drop it on the Toolbar. The new document will have the same dimensions as the image.
...
- [Stock panel](../23-panels/15-stock-panel.md)
