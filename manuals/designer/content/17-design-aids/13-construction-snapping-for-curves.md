...
| Control handle snapping behaviour | Example |
| --- | --- |
...
These snapping options operate independently of [global snapping](11-snapping.md). They help avoid having to align control handles to grid or guide and offer additional accuracy and symmetry once nodes have been positioned using [Curve snapping](12-curve-snapping.md) options.
...
- [Curve snapping](12-curve-snapping.md)
