...
- ![Add new guide](../../assets/shared/ui/add_layer.png)
...
**![Move Horizontal Cursor](../../assets/shared/cursor/cursor_moveHorizontal.png)

 ![Move Vertical Cursor](../../assets/shared/cursor/cursor_moveVertical.png)
...
- ![Remove guide](../../assets/shared/ui/trash_can.png)
...
- From the **View** menu, switch on **Show Column Guides** then select **Guides**. The **Column Guides** section allows you to manage the following:
  ...
  - **Colour**—click the colour swatch to select a colour for your column guides.
