...
Any edits you make to your document are stored in the [History panel](../23-panels/09-history-panel.md). You can then use this, or keyboard shortcuts, to undo an edit. You can also redo an edit which you have recently undone.
...
3. [Save your document.](../03-get-started/16-save.md)
...
1. In the **Affinity Designer** menu, click **Settings** (or **Preferences**).
2. In the **Edit** menu, click **Settings** (or **Preferences**).
3. Click **Performance**.
...
- [Save](../03-get-started/16-save.md)
