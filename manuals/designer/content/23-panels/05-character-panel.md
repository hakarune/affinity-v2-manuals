...
- Text Style—allows a character [text style](../12-text/text-styles/01-using-text-styles.md) to be applied to selected text.

**Decorations**

- ![No underline](../../assets/shared/ui/nounderline.png)

   ![Single Underline](../../assets/shared/ui/singleunderline.png)

   ![Double Underline](../../assets/shared/ui/doubleunderline.png)
...
- ![No Strikethrough](../../assets/shared/ui/nostrikethrough.png)

   ![Single Strikethrough](../../assets/shared/ui/singlestrikethrough.png)

   ![Double Strikethrough](../../assets/shared/ui/doublestrikethrough.png)
...
- ![Kerning](../../assets/shared/ui/char_kerning.png)
...
- ![Horizontal Scale](../../assets/shared/ui/char_horz_scale.png)

   **Horizontal Scale**—stretches the characters and spacing width with regard to point size.
- ![Vertical Scale](../../assets/shared/ui/char_vert_scale.png)

   **Vertical Scale**—stretches the characters with regard to point size.
- ![Superscript / Subscript](../../assets/shared/ui/super-subscript.png)
...
- ![Standard Ligatures](../../assets/shared/ui/standard_ligatures.png)

   **Standard Ligatures**—applies any available typeface ligatures to the selected text.
- ![Contextual Alternatives](../../assets/shared/ui/contextual_alternatives.png)
...
- ![Subscript](../../assets/shared/ui/subscript.png)
...
- [Character formatting](../12-text/07-character-formatting.md)
- [OpenType font features](../12-text/09-opentype-font-features.md)
- [Paragraph panel](13-paragraph-panel.md)
