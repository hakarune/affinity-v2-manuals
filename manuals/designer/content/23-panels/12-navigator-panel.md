...
- Click ![Zoom In](../../assets/shared/ui/zoomin.png)

   **Zoom In** or ![Zoom Out](../../assets/shared/ui/zoomout.png)

   **Zoom Out**.
- Drag the slider to change the zoom level.
- Click the numerical zoom level, type a new value, then press the `Enter` .
...
2. ![Panel Preferences](../../assets/shared/ui/moremenuicon.png)

   From **Panel Preferences**, select **Save Current View Point**.
...
2. ![Panel Preferences](../../assets/shared/ui/moremenuicon.png)
   ...
   From **Panel Preferences**, select **Remove Selected View Point**.
...
2. ![Panel Preferences](../../assets/shared/ui/moremenuicon.png)
   ...
   From **Panel Preferences**, select **Rename View Point**.
...
> **Note:** Commands for moving between view points are mappable to custom keyboard shortcuts; see [Customising shortcuts](../21-workspace/customise/01-keyboard-shortcuts.md) for more information.
