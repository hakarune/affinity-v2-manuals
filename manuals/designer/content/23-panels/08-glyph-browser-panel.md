...
The **Glyph Browser** panel is available from both the Designer and Pixel Personas and can be switched on via **Window>Text**.
...
1. On your document, use either the [Artistic Text Tool](../22-tools/text-tools/01-artistic-text-tool.md) or [Frame Text Tool](../22-tools/text-tools/02-frame-text-tool.md) to create a text layer and begin editing it.
...
- [Opening documents and images](../03-get-started/04-open-documents-and-images.md)
