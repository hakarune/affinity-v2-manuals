...
- Adjust the behaviour of justified text—giving you control over how the app calculates spacing between letters and words to allow text to be flush along both left and right margins.
...
- Text Style—allows a paragraph [text style](../12-text/text-styles/01-using-text-styles.md) to be applied to selected text.
...
- ![First Line indent](../../assets/shared/ui/indent_firstline.png)

   **First Line Indent**—controls the indent applied to the first line of the paragraph.
- ![Last Line Outdent](../../assets/shared/ui/outdent_lastline.png)

   **Last Line Outdent**—controls the outdent applied to the last line of the paragraph.
- ![Space After Paragraph](../../assets/shared/ui/after_paragraph.png)
...
- ![Tab stop leader none](../../assets/shared/ui/leader_none.png)

   ![Tab stop leader character](../../assets/shared/ui/leader_glyph.png)

   ![Tab stop leader underline](../../assets/shared/ui/leader_underline.png)

   ![Tab stop leader strikeout](../../assets/shared/ui/leader_strikeout.png)

   Tab stop leader—sets the characters displayed which indicates the selected tab stop.

> **Note:** See the [Paragraph formatting](../12-text/08-paragraph-formatting.md) topic for more information.

**Justification**

- ![Minimum Word Spacing](../../assets/shared/ui/word_spacing_min.png)

   **Minimum Word Spacing**—sets the minimum gap allowed.
- ![Desired Word Spacing](../../assets/shared/ui/word_spacing_desired.png)

   **Desired Word Spacing**—sets the preferred gap between words.
- ![Maximum Word Spacing](../../assets/shared/ui/word_spacing_max.png)

   **Maximum Word Spacing**—sets the maximum gap allowed.
- ![Minimum Letter Spacing](../../assets/shared/ui/letter_spacing_min.png)

   **Minimum Letter Spacing**—sets the minimum tracking allowed.
- ![Desired Letter Spacing](../../assets/shared/ui/letter_spacing_desired.png)
...
- ![Maximum Letter Spacing](../../assets/shared/ui/letter_spacing_max.png)
...
- **Alignment**—select from **Left Align Bullet/Number**, **Centre Align Bullet/Number**, or **Right Align Bullet/Number**. For the latter two options, **First Line Indent** must be greater than 0.
...
- [Paragraph formatting](../12-text/08-paragraph-formatting.md)
- [Character panel](05-character-panel.md)
