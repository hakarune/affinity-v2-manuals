...
The panel also gives you options for creating new paragraph and character styles, refining existing styles, or deleting them.
...
For more information on using text styles, see [Using text styles](../12-text/text-styles/01-using-text-styles.md).

![Text Styles panel](../../assets/images/panel_textstyles.png)
...
- **Import Styles**—when selected, opens a pop-up dialog allowing you to select a style to import.
...
- ![Reapply text styles](../../assets/shared/ui/ReapplyTextStyles.png)

   **Reapply Text Styles**—removes local formatting from the selected text, ensuring it honours the Current Formatting perfectly.
- ![Paragraph text style](../../assets/shared/ui/ParagraphStyle.png)

   ![Character text style](../../assets/shared/ui/CharacterStyle.png)

   Type—specifies whether the text style is a [paragraph, character or group type](../12-text/text-styles/04-text-style-types.md).
...
- ![Create Paragraph Style](../../assets/shared/ui/CreateParagraphStyle.png)
   ...
   **Create Paragraph Style**—launches the **Edit Text Style** dialog ready for [creating a new paragraph style](../12-text/text-styles/02-creating-and-managing-text-styles.md).
- ![Create Character Style](../../assets/shared/ui/CreateCharacterStyle.png)

   **Create Character Style**—launches the **Edit Text Style** dialog ready for [creating a new character style](../12-text/text-styles/02-creating-and-managing-text-styles.md).
- ![Create Group Style](../../assets/shared/ui/CreateGroupStyle.png)

   **Create Group Style**—launches the **Edit Text Style** dialog ready for [creating a new group style](../12-text/text-styles/02-creating-and-managing-text-styles.md).
