...
5. (Optional) Hold the `Shift`  and press the right and down arrow keys to adjust the spacing between columns or rows, respectively, by 10x the usual increment. (Conversely, press the left and up arrow keys to decrease spacing by the same amount.)
