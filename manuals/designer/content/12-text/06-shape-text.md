...
![Shape text](../../assets/shared/shapetext.png)
...
> **Tip:** Alternatively, select a previously drawn curve or shape and then, from the **Layer** menu, select **Convert to Text Frame**.
