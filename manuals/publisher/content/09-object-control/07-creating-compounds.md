...
Unlike [joining objects](06-joining-objects.md), creating a Compound is a non-destructive process. This means a Compound can be added to, or broken apart, at any time. Objects within the Compound can also be removed and modified without restriction, if and when desired.
...
- [Joining objects](06-joining-objects.md)
