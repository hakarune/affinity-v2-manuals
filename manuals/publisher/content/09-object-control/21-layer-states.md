...
![Before](../../assets/shared/layer-states-pub-before.png)
![After](../../assets/shared/layer-states-pub-after.png)
*Before and after a query applied: German and English language version, respectively.*
...
![A query](../../assets/images/pub-states-query-layers.png)
...
- Switching the visibility of personal notes on and off while preparing a report or an advertising campaign proposal document.
- Applying various colors and text in response to the promotional time left on an advert.
- Previewing approved layout and content changes in editorial publications.

> **Note:** Find and replace can locate document text that matches a pattern. See [Regular expressions](../23-extras/02-using-regular-expressions-in-affinity.md) for more information. Detailed information about the capabilities of regular expressions is available on the Web.
...
- [States panel](../21-panels/23-states-panel.md)
- [About layers](../08-layers/01-about-layers.md)
- [Viewing](../08-layers/06-arrange-manage-layers.md)
- [Layers panel](../21-panels/14-layers-panel.md)
- [Regular expressions](../23-extras/02-using-regular-expressions-in-affinity.md)
