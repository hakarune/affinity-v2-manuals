...
> **Note:** If you need to use a color space that is not available in Affinity Publisher, it will have to be installed on your system. Devices can install color profiles for you. Consult your system's color management documentation for instructions.
