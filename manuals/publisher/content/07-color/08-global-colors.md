...
![Global color before](../../assets/shared/globalclr_before.jpg)
![Global color after](../../assets/shared/globalclr_after.jpg)

## About global colors

The global color could be applied as a solid fill, stroke, or a color used in a gradient fill. They can be made while in RGB, CMYK, HSL, LAB, Grayscale, or Tint color modes.
...
> **Note:** ![Global color thumbnail](../../assets/shared/globalclr_thumbnail.png) A global color is indicated by a tab in the bottom-left corner of its color swatch.

> **Tip:** You can check if a global color has been assigned to an object's stroke or fill by using the Color panel.

**macOS:**

> **Note:** If you're [importing a document palette](../15-add-ons/04-importing-add-ons.md) containing global colors as a System or Application palette, the global colors will be converted to standard colors.

**Windows:**

> **Note:** If you're [importing a document palette](../15-add-ons/04-importing-add-ons.md) containing global colors as an Application palette, the global colors will be converted to standard colors.
