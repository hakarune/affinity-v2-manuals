...
The act of color picking lets you sample colors within or outside Affinity Publisher, then use them throughout your design.

![Sampling colors](../../assets/shared/sampling_colours.png)
...
- A color picker appears on the **Color** and **Swatches** panels (and other color-related pop-up panels).
- The standalone **Color Picker Tool** appears on the **Tools** panel.
...
> **Note — Modifier(s):** **macOS:** With shape and gradient tools, you can sample color by dragging with the `Alt`  pressed.
>
> **Windows:** With shape and gradient tools, you can sample color by dragging with the `Alt`  pressed.
