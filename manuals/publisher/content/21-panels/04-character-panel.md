...
- Text Style—allows a character [text style](../10-text/10-text-styles/01-using-text-styles.md) to be applied to selected text.
...
- ![Shear](../../assets/shared/ui/char_shear.png) **Shear**—controls the extent of text slant. Positive values will tilt text to the right, negative values will tilt text to the left.
