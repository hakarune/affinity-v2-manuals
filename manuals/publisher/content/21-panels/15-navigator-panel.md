...
![Navigator panel](../../assets/images/panel_navigator.png)
...
- Click ![Zoom In](../../assets/shared/ui/zoomin.png) **Zoom In** or ![Zoom Out](../../assets/shared/ui/zoomout.png) **Zoom Out**.
...
2. ![Panel Preferences](../../assets/shared/ui/moremenuicon.png) From **Panel Preferences**, select **Save Current View Point**.
...
2. ![Panel Preferences](../../assets/shared/ui/moremenuicon.png) From **Panel Preferences**, select **Remove Selected View Point**.

**To rename a view point:**

1. From the pop-up menu, select a view point.
2. ![Panel Preferences](../../assets/shared/ui/moremenuicon.png) From **Panel Preferences**, select **Rename View Point**.
...
> **Note:** Commands for moving between view points are mappable to custom keyboard shortcuts; see [Customizing shortcuts](../19-workspace/04-customize/01-keyboard-shortcuts.md) for more information.
