...
![Glyph Browser panel](../../assets/images/panel_glyph.png)
*The Glyph Browser panel.*

**To add a Glyph:**

1. On your document, use either the [Artistic Text Tool](../20-tools/02-text-tools/03-artistic-text-tool.md) or [Frame Text Tool](../20-tools/02-text-tools/01-frame-text-tool.md) to create a text layer and begin editing it.
...
- ![Lock/Unlock](../../assets/shared/ui/lock_layer.png) **Lock Font and Traits**—When unlocked, the font shown in the panel changes with the selected text's font, making it easier to find glyphs from the currently selected font. When locked, the font shown in the panel doesn’t change with text selection. This makes it easier to repeatedly use glyphs from a particular font, typically a symbol font like FontAwesome.
...
- [Opening documents and images](../04-get-started/02-open-documents.md)
