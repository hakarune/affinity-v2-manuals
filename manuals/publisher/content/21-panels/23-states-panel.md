...
Any state or query can be instantly applied to all or some of your document's layers, allowing you to easily compare different directions for your work. To learn more about the application of states and queries, view the [Layer states](../09-object-control/21-layer-states.md) topic.

![States panel](../../assets/images/publisher-panel-states.png)
*Affinity Publisher 2 States panel.*

> **Note:** The **States** panel is hidden by default. It can be switched on via the **Window** menu.
...
- [Layers panel](14-layers-panel.md)
