...
Any edits you make to your document are stored in the [History panel](../21-panels/11-history-panel.md). You can then use this, or keyboard shortcuts, to undo an edit. You can also redo an edit which you have recently undone.
...
3. [Save your document.](../04-get-started/12-save.md)
...
1. **macOS:** In the **Affinity Publisher** menu, click **Settings** (or **Preferences**).
...
- [History panel](../21-panels/11-history-panel.md)
