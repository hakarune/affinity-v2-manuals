...
Guides are non-printing, non-exporting lines that 'float' over your page and assist with their positioning. There are two types of guides to aid a variety of designs—ruler and column. They can be created and positioned by dragging from a ruler (for 'by eye' placement) or via **View>Guides** (for precision using the document's units or a percentage).

![Guides](../../assets/shared/guides.jpg)
*Text frame, footer text, and icons aligned to ruler guides. Dashed guides are from master page.*

![Column guides](../../assets/shared/guides_column.jpg)
...
- With the **Move Tool** active, for 'by eye' placement, drag from either the horizontal or vertical [ruler](08-rulers.md) which can be switched on via the **View** menu.
...
>
> Guides added to Master Pages will show on your publication pages as dashed guide lines, while guides placed on the publication page directly show as solid lines.

> **Tip:** Guide positions will automatically update relative to a repositioned [spread origin](08-rulers.md). For example, you can position the spread origin to the center of a spread and position guides relative to that zero point (e.g., vertical guides at -40mm and 40mm).
...
> **Tip:** Guide positions will automatically update relative to a repositioned [spread origin](08-rulers.md).
...
Column guides allow you to specify a number of evenly spaced columns and rows and are perfect for designing page layouts.
