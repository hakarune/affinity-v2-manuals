...
The Rounded Rectangle Tool provides an easy way to create rectangles with rounded corners.

![Rounded rectangle default](../../../assets/shared/shapes_roundedRectangle1.png)
*Default shape and handle position (in red) before customization.*

> **Tip:** Tool shortcut : `M`. This also cycles through to select the **Rectangle** and **Ellipse** tools.

## Customization

The Rounded Rectangle Tool has several options on the shape and on the context toolbar to enable the radius of the corners to be controlled.

![Rounded rectangle alternatives](../../../assets/shared/shapes_roundedRectangle2.png)
...
- [Rectangle Tool](01-rectangle-tool.md)
