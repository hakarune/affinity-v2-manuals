...
![Diamond default](../../../assets/shared/shapes_diamond1.png)
*Default shape and handle position (in red) before customization.*

## Customization

The Diamond Tool has the option on the shape and on the context toolbar to change the height of the midpoint to create a kite shape.

![Diamond alternatives](../../../assets/shared/shapes_diamond2.png)
