...
Spirals display a series of non-editable points along their path which help to indicate the shape's geometry and resulting node positions if the spiral is [converted to curves](../../09-object-control/17-convert-objects-to-curves.md).
