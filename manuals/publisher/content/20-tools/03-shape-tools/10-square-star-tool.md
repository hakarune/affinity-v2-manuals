...
![Square Star default](../../../assets/shared/shapes_squareStar1.png)
...
![Square Star alternatives](../../../assets/shared/shapes_squareStar2.png)
...
- **Cutout**—controls the width of all squared points by cutting out the region between the shape's selection box and the red shape handle.
