...
The **Pie Tool** makes it easy to create pie shapes, pie segments and donuts with segments removed. As the segments are geometrically correct, it's easy to create shapes with the exact angle you need for charts and other uses.

![Pie default](../../../assets/shared/shapes_pie1.png)
*Default shape and handle position (in red) before customization.*

## Customization

The Pie Tool has several options on the shape and on the context toolbar to enable the start and end angle and the size of the donut hole to be controlled.

![Pie alternatives](../../../assets/shared/shapes_pie2.png)
