...
The [Stock panel](../21-panels/24-stock-panel.md) allows you to search various stock imagery websites to find images and then add them to the page.
...
> **Note:** ![Clear search](../../assets/shared/ui/SearchFieldClose.png) You can clear search results using the close icon.
...
- [Stock panel](../21-panels/24-stock-panel.md)
