...
> **Tip:** Shapes can be converted to text frames or picture frames via **Layer>Convert to Text Frame** or **Layer>Convert to Picture Frame**, respectively.
...
> **Tip:** Applying a rounded corner to a geometric shape using the **Corner Tool** will automatically convert that shape to curves. From that point, you won't be able to make use of the shape tool's inherent 'morphing' behavior.
...
- [About geometric shapes](04-about-geometric-shapes.md)
