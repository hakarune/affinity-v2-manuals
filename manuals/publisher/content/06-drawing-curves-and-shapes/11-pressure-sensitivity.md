...
Affinity desktop apps offers complete flexibility when using pen tablets or Force Touch-enabled devices for real pressure-sensitive drawing. If you prefer a mouse or trackpad (not Force Touch), Affinity apps offers simulated pressure sensitivity.

**Windows:**

Affinity desktop apps offer complete flexibility when using pen tablets for real pressure-sensitive drawing. If you prefer a mouse, Affinity apps offers simulated pressure sensitivity.

When using the Pen Tool you can simply connect your device and you're ready to go.
...
2. Manipulate the graph to form the desired pressure profile. (See examples below.)
...
- [Stroke panel](../21-panels/25-stroke-panel.md)
