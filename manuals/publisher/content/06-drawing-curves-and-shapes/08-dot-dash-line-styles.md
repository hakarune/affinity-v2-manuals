...
> **Note:** You can choose between dots or dashes by setting the **Cap** type on the **Stroke** panel or via **Stroke properties**. Use **Round Cap** for dots and rounded dashes, **Butt Cap** for squared dashes.
