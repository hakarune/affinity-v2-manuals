...
![Bleed guides](../../../assets/images/bleedguide.png)
...
![Bleed on output](../../../assets/images/bleedoutput.png)
...
- Select the **Bleed** tab, and do one of the following:
  ...
  - ![link](../../../assets/shared/ui/chainlinkconnected.png) ![Unlink](../../../assets/shared/ui/chainlink.png) For the same bleed value: Enable the Link symbol at right, and set any bleed value; all other values will update to this.
...
- **macOS:** For print: From the **File** menu, select **Print**. Click **Show Details**, then **Bleed and Marks**, and check **Include bleed**.
- **Windows:** For print: From the **File** menu, select **Print**. Select **Bleed and Marks** and check **Include bleed**.
