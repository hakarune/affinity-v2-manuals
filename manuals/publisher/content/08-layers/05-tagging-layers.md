...
![Layer color tagging](../../assets/shared/layers_tagging.png)
*Layers showing color tagging as vertical colored strips at the end of each entry.*

Tagging provides a useful additional means of organizing layer content beyond grouping layers, as it allows you to organize a set of layers without affecting the layer order. All layers that share the same tag color can be [selected at once](04-selecting-and-editing-layers.md) from the **Layers** panel.

**To assign a tag color to a layer(s):**

1. (Optional) On the **Layers** panel, select multiple layers.
2. Do one of the following:
  - ![Toggle Visibility](../../assets/shared/ui/visibility_on.png) `Click`-click **Toggle Visibility**, and select a color tag from the pop-up menu. For multiple selected layers, any of the selected layers can be targeted.
...
- [Selecting](../09-object-control/01-selecting-objects.md)
