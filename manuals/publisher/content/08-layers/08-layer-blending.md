...
Hue Combine the hue of the active layer with that of the underlying layer(s). Use to exaggerate or create intense colors and to produce vivid, often surreal scenes.  Hue isn't available in Grayscale mode.   ![Hue blend mode](../../assets/shared/hue_triptych_test.jpg)
...
- [Layer blend ranges](09-layer-blend-ranges.md)
